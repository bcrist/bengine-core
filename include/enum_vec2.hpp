#pragma once
#ifndef BE_CORE_ENUM_VEC2_HPP_
#define BE_CORE_ENUM_VEC2_HPP_
...
#pragma GCC diagnostic pop
   ...
   constexpr enum_vec(T x, T y);

   constexpr enum_vec(const enum_vec<1, T>& x, const enum_vec<1, T>& y);
